...
import { BookOpen, Calendar, ClipboardList, FileText, Archive, Vault, FileQuestion } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = [
    ...
    { path: '/reward-vault', label: 'Rewards', icon: Vault },
    { path: '/question-papers', label: 'Papers', icon: FileQuestion },
  ];
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b-2 border-primary/20 bg-card shadow-web sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          ...
          <nav className="flex justify-center gap-1 flex-wrap">
            {navItems.map((item) => {
